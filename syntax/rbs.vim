...
execute 'syn match rbsMethodName /\%#=1\%(\<self\>?\=\.\)\='.g:ruby#syntax#overloadable_operators.'/ contained nextgroup=rbsMethodDeclarationOperator skipwhite'
...
execute 'syn match rbsAttributeName /\%#=1'.g:ruby#syntax#overloadable_operators.'/ contained nextgroup=rbsAttributeDeclarationOperator,rbsAttributeVariable skipwhite'
...
execute 'syn match rbsMethodAliasName /\%#=1\%(\<self\>\.\)\='.g:ruby#syntax#overloadable_operators.'/ contained nextgroup=rbsMethodAliasName skipwhite'
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1"/ end=/\%#=1"/ contained contains=rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
syn match rbsStringEscape /\%#=1\\\%(\o\{1,3}\|x\x\x\=\|u\%(\x\{4}\|{\x\{1,6}\%(\s\x\{1,6}\)*}\)\|\%(c\|C-\)\%(\\M-\)\=.\|M-\%(\\c\|\\C-\)\=.\|\_.\)/ contained
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1'/ end=/\%#=1'/ contained contains=rbsQuoteEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
syn match rbsQuoteEscape /\%#=1\\[\\']/ contained

syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%Q\=(/ end=/\%#=1)/ contained contains=rbsStringParentheses,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%Q\=\[/ end=/\%#=1]/ contains=rbsStringSquareBrackets,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%Q\={/ end=/\%#=1}/ contains=rbsStringCurlyBraces,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%Q\=</ end=/\%#=1>/ contains=rbsStringAngleBrackets,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%Q\=\z([~`!@#$%^&*_\-+=|\\:;"',.?/]\)/ end=/\%#=1\z1/ skip=/\%#=1\\\\\|\\\z1/ contained contains=rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl

syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%q(/ end=/\%#=1)/ contains=rbsRawStringParentheses,rbsParenthesisEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%q\[/ end=/\%#=1]/ contains=rbsRawStringSquareBrackets,rbsSquareBracketEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%q{/ end=/\%#=1}/ contains=rbsRawStringCurlyBraces,rbsCurlyBraceEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%q</ end=/\%#=1>/ contains=rbsRawStringAngleBrackets,rbsAngleBracketEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
...
syn region rbsString matchgroup=rbsStringDelimiter start=/\%#=1%q\z([~`!@#$%^&*_\-+=|\\:;"',.?/]\)/ end=/\%#=1\z1/ skip=/\%#=1\\\\\|\\\z1/ contained nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl

syn match rbsSymbol /\%#=1:\h\w*[=?!]\=/ contained contains=rbsSymbolDelimiter nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
syn match rbsSymbolDelimiter /\%#=1:/ contained

syn region rbsSymbol matchgroup=rbsSymbolDelimiter start=/\%#=1:"/ end=/\%#=1"/ contained contains=rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
syn region rbsSymbol matchgroup=rbsSymbolDelimiter start=/\%#=1:'/ end=/\%#=1'/ contained contains=rbsQuoteEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl

syn region rbsSymbol matchgroup=rbsSymbolDelimiter start=/\%#=1%s(/  end=/\%#=1)/ contained contains=rbsStringParentheses,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
syn region rbsSymbol matchgroup=rbsSymbolDelimiter start=/\%#=1%s\[/ end=/\%#=1]/ contained contains=rbsStringSquareBrackets,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
syn region rbsSymbol matchgroup=rbsSymbolDelimiter start=/\%#=1%s{/  end=/\%#=1}/ contained contains=rbsStringCurlyBraces,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
syn region rbsSymbol matchgroup=rbsSymbolDelimiter start=/\%#=1%s</  end=/\%#=1>/ contained contains=rbsStringAngleBrackets,rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl

syn region rbsSymbol matchgroup=rbsSymbolDelimiter start=/\%#=1%s\z([~`!@#$%^&*_\-+=|\\:;"',.?/]\)/ end=/\%#=1\z1/ skip=/\%#=1\\\\\|\\\z1/ contained contains=rbsStringEscape nextgroup=rbsTypeOperator,rbsOptionalTypeOperator skipwhite skipnl
