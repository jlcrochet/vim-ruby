...
" Numbers {{{3
" The following two patterns were generated by tools/syntax.rb:
syn match rubyNumber /\%#=1[1-9]\d*\%(_\d\+\)*\%([eE][+-]\=\d\+\%(_\d\+\)*i\=\|\.\d\+\%(_\d\+\)*\%([eE][+-]\=\d\+\%(_\d\+\)*i\=\|r\=i\=\)\|ri\=\|i\)\=\>/ nextgroup=@rubyPostfix skipwhite
syn match rubyNumber /\%#=10\%([eE][+-]\=\d\+\%(_\d\+\)*i\=\|\.\d\+\%(_\d\+\)*\%([eE][+-]\=\d\+\%(_\d\+\)*i\=\|r\=i\=\)\|ri\=\|i\|\o\+\%(_\o\+\)*r\=i\=\|[bB][01]\+\%(_[01]\+\)*r\=i\=\|[oO]\o\+\%(_\o\+\)*r\=i\=\|[dD]\d\+\%(_\d\+\)*r\=i\=\|[xX]\x\+\%(_\x\+\)*r\=i\=\)\=\>/ nextgroup=@rubyPostfix skipwhite
