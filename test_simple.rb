...
# It's common for Ruby files to consist of a single, large class
# definition, so we want to make sure that we are testing that case for
# TODO: jksldfjkldsf
# performance:
module Module
   @@ = 123
...
SQUIGGLY_HEREDOC
      ...
      expected_result = <<-'EXPECTED'.downcase
      jklsdfjklsdf
One plus one is #{1 + 1}
...
THIRD
      ...
      /a\Qjkls\b\\dfjklsdf|jks\/ldf\Ejksl(?imx)dfjlksdf|jksdl#{jksdlf + 123}fjkls{{ foo + 123 }}df/
