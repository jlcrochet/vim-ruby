...
" `in` is a short word that is a common prefix for other words, so we need to
" add some additional checks for it:
let s:in_characters = 'abcdefghijklmnopqrstuvwxyz0123456789_?!:'
